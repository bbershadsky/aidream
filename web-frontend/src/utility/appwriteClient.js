...
const APPWRITE_PROJECT = import.meta.env.VITE_NEXT_PUBLIC_APPWRITE_ENDPOINT;
const resources = {
...
export { appwriteClient, account, storage, resources, getPrefs, updatePrefs, updateName, updateEmail, };
